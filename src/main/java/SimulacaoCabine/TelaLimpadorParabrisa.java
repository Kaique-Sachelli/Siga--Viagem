...
public class TelaLimpadorParabrisa extends javax.swing.JFrame {

    private JFrame frame;
    
    public TelaLimpadorParabrisa() {
        initComponents();
    }

    public TelaLimpadorParabrisa(JFrame frame) {
        this.frame = frame;
    ...
    private void initComponents() {
        ...
        LimpadorParabrisaLabel = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Tela Limpador Parabrisa");
        ...
        LimpadorParabrisaLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SimulacaoImagens/limpador de parabrisa (1) (3).jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLimpadorParabrisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLimpadorParabrisa().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel LimpadorParabrisaLabel;
