...
public class TelaEsqueceuSenha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fale com o administrador para alterar sua senha!");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, -1, 50));
